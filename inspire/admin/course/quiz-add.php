...
$conn = connect();
#DB Fetching#
$stmt = $conn->prepare("SELECT sno FROM inspire_quiz order by sno desc limit 1");
$stmt->execute();
$qno = $stmt->fetchColumn() + 1;
                        ...
                        <div class="card-body row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <select class="form-control" id="qid" name="qid" placeholder="Quiz ID" onchange="CheckCID(this)" required></select>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-floating mb-1">
                                        <input type="number" class="form-control" name="qno" id="qno">
                            ...
                            <div class="col-lg-12">
                                    <div class="form-floating mb-1" id="q_img" >
                                        <input type="file" name="image[0]" class="form-control" id="image[0]" onchange="CheckImage()" accept="image/*" >
                                    </div>
                                </div>
                                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-body row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-6">
                                <div class="form-floating mb-1">
                                <input  type="number" class="form-control" name="ans" id="ans" placeholder="Final Answer" required>
                                ...
                                <span style="display:none">
                                    <input type="text" id="key" placeholder="" name="key" value="quiz_add" hidden></span>

                                <div class="col-12">
                                    <input data-loading-text="Saving Quiz..." type="submit" id="submit" name="submit" value="Submit" class="btn btn-primary theme-btn invoice-save-btm px-5">
...
<script>
    var file = document.getElementById("image[0]");
    var image_upload_flag =0;
    function CheckImage() {
      ...
      var qidapiUrl = siteUrl + "admin/api/get.php?method=get_qid";
        ...
        success: function(response) {
            ...
            for (var i = 0; i < jsonData.length; i++) {
                jdata = jsonData[i];
                appenddata += "<option value ='" + jdata["quizid"] + "'>" + jdata["quizid"] + "</option>";

            }
            $("#qid").append(appenddata);
        },
...
<script>
    ...
    $('#quiz_form').submit(function(event) {
        ...
        if((editorText1=='') && (image_upload_flag==0)){
...
function CheckCID() {
        quiz_id = document.getElementById("qid").value;
        if (quiz_id == '') {
            $('#qid').val('');
            alert('Please select the Quiz ID!');
        }
