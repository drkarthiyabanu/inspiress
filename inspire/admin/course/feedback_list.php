...
<script>
	var apiurl = "https://edinztech.com/inspire/admin/api/get.php?method=feedback_list";
var siteUrl ="https://edinztech.com/inspire/admin/";
    $(function() {
        ...
        fields: [
            ...
            { name: "comment" , type: "text", title: "Comment", width: "auto", align: 'center', validate: "required"},
//----image----
            // {
            //   type: "control",
            //   width: 'auto',
...
//Jsgrid fileds
       ...
       if (navigator.msSaveBlob) { // IE 10+
           navigator.msSaveBlob(blob, "Feedback.csv")
       }
       else {
