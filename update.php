...
<!-- Page Title -->
  <div class="page-title dark-background" data-aos="fade" style="background-image: url(assets/img/page-title-bg.webp);">
    <div class="container position-relative">
      <h1>Certification Correction</h1>
...
SIDCO Industrial Estate, Guindy, Tamil Nadu, Chennai- 600032</p>
      ...
      <div class="feedback-container">
        <h2>Fill the form for certification correction.</h2>
  ...
  <div class="input-group">
    <input type="number" id="mobile" name="mobile" placeholder="Enter Mobile Number" required onkeypress="return blockSpecialChar(event)" pattern="[0-9]{10}" />
                            ...
                            <input type="text" id="key" placeholder="" name="key" value="update_feedback" hidden></span>
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.statusCode == 202) {
                alert("Fill the feedback form first!");
