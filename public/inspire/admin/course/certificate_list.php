...
<main id="main" class="main">
    ...
    <div class="pagetitle d-flex flex-md-row">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <nav>
                            ...
                            <li class="breadcrumb-item">Certificate List</li>
                            </ol>
                        </nav>
                    </div>
        ...
        <div class="ms-md-auto ms-0 mt-2 mt-md-0 d-flex align-items-center align-buttons">
          <a href="certificate-add" class="btn btn-primary theme-btn-inline"><span class="iconify" data-icon="bi:plus"></span> Add</a>
...
<script>
var apiurl = "https://edinztech.com/inspire/admin/api/get.php?method=certificate_list";
...
//----image----
            
            {
              ...
              itemTemplate: function(value, item) {
                  ...
                  ).attr("href",  "https://edinztech.com/inspire/admin/course/certificate-edit?id="+item.id).text("Edit");
                  return $("<div>").append(customviewButton);
              }
            },
    ...
    function deleterecord(token) {
        ...
        var objectvalue = {};
        objectvalue.key = "certificate_delete";
