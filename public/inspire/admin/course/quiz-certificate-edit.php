...
$conn = connect();
    #DB Fetching#
    $query = "select * from quiz_certificates where id='" . $id . "' ";
          ...
          <div class="card">
            <div class="card-body row">
              ...
              <div class="col-lg-2">
                            ...
                            <input type="number" class="form-control" name="qnum1" id="qnum1" value="<?php echo $id; ?>" disabled>
                                <input type="number" class="form-control" name="qnum" id="qnum" value="<?php echo $id; ?>" Hidden>
                                <label for="qnum">S.No:</label>
                        ...
                        <div class="col-lg-4">
                            <div class="form-floating mb-1">
                            <input type="text" class="form-control" name="quiz_id" id="quiz_id" onchange="CheckQID(this)" value="<?php echo $row['quizid'];?>" disabled>
                          ...
                          <div class="col-lg-8">
                              <div class="form-floating mb-1">
                              <input value="<?php echo $row['quizname'];?>" type="text" class="form-control" name="qname" id="qname" >
                                
                                  <label for="cname">Quiz Name:</label>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="col-lg-1">
                              ...
                              <a href="https://inspiress.in/quiz_certificate/<?php echo $row['cpath']; ?>" target="blank"><i class="fa fa-eye" aria-hidden="true"></i></a>
                            ...
                            <input type="text" id="key" placeholder="" name="key" value="quiz_certificate_update" hidden></span>
