...
<main id="main" class="main">
    ...
    <div class="pagetitle d-flex flex-md-row">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <nav>
                            ...
                            <li class="breadcrumb-item">Inspire ID List</li>
                            </ol>
                        </nav>
                    </div>
        ...
        <div class="ms-md-auto ms-0 mt-2 mt-md-0 d-flex align-items-center align-buttons">
          <a href="inspireid-add" class="btn btn-primary theme-btn-inline"><span class="iconify" data-icon="bi:plus"></span> Add</a>
...
<script>
var apiurl = "https://edinztech.com/inspire/admin/api/get.php?method=inspireid_list";
var siteUrl ="https://edinztech.com/inspire/admin/";
    $(function() {
        ...
        fields: [
            ...
            { name: "inspireid" , type: "text", title: "Inspire ID", width: "auto",  align: 'center', validate: "required"},
            ...
            { name: "flag" , type: "text", title: "Flag", width: "auto", align: 'center', validate: "required"},
//----image----
            // {
            //   type: "control",
            //   width: 'auto',
