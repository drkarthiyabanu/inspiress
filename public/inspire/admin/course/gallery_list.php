...
<main id="main" class="main">
    ...
    <div class="pagetitle d-flex flex-md-row">
        ...
        <div class="ms-md-auto ms-0 mt-2 mt-md-0 d-flex align-items-center align-buttons">
          <a href="gallery-add" class="btn btn-primary theme-btn-inline"><span class="iconify" data-icon="bi:plus"></span> Add</a>
...
<script>
var apiurl = "https://edinztech.com/inspire/admin/api/get.php?method=gallery_list";
var siteUrl ="https://edinztech.com/inspire/admin/";
    $(function() {
        ...
        fields: [
            ...
            { name: "ititle" , type: "text", title: "Image Title", width: "auto",  align: 'center', validate: "required"},
            // { name: "courseid" , type: "text", title: "Course ID", width: "auto", align: 'center', validate: "required"},
            // { name: "coursename" , type: "text", title: "Course Name", width: "auto", align: 'center', validate: "required"},
...
//----image----
            {
              ...
              itemTemplate: function(value, item) {
                  ...
                  ).attr("href",  'https://edinztech.com/img/gallery/'+item.ipath).text("Image");
...
//----image----
            ...
            //       ).attr("href",  "https://inspiress.in/admin/course/certificate-edit?id="+item.id).text("Edit");
            //       return $("<div>").append(customviewButton);
            //   }
            // },
    ...
    function deleterecord(token) {
        ...
        var objectvalue = {};
        objectvalue.key = "gallery_delete";
